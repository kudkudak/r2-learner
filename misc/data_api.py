...
def fetch_all_datasets(tripled=False):
    return fetch_uci_datasets(['australian', 'bank', 'breast_cancer', 'crashes',\
                               'diabetes', 'fourclass', 'german', 'glass', 'heart',
                               'indian', 'ionosphere', 'iris', 'liver', 'pendigits',\
                               'satimage', 'segment', 'sonar', 'splice', 'svmguide2',\
                               'svmguide4', 'vehicle', 'vowel', 'wine'], tripled=tripled)
